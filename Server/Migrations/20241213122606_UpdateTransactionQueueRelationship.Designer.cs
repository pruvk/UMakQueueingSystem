...
namespace Server.Migrations
{
    ...
    [Migration("20241213122606_UpdateTransactionQueueRelationship")]
    partial class UpdateTransactionQueueRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Server.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("Server.Models.Queue", "Queue")
                        .WithOne("Transaction")
                        .HasForeignKey("Server.Models.Transaction", "QueueId");
